        ...
        <div class="drawer-content flex flex-col">
            ...
            <div class="max-w-4xl mx-auto px-4 py-8">
                ...
                <article class="prose prose-lg max-w-none">
                        ...
                        <div class="card-body p-6">
                            <div class="flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-base-content/70">{{ $post->user->bio ?? '这个作者很懒，还没有写简介' }}</p>
                                    <div class="flex gap-4 mt-2">
                                        <span class="text-sm text-base-content/70">
                                            <i class="fas fa-pencil-alt"></i> 42 篇文章
                                        </span>
                                        <span class="text-sm text-base-content/70">
                                            <i class="fas fa-users"></i> 1.2k 关注者
                                        </span>
                                    </div>
                                </div>
                                <button class="btn btn-primary btn-sm ml-auto">关注作者</button>
                            </div>
                        </div>
                    </div>
                    ...
                    <!-- 文章标签 -->
                    <div class="flex gap-2 mb-8 not-prose">
